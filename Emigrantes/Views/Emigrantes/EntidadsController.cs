...
namespace Emigrantes.Views.Emigrantes
{
    public class EntidadsController : Controller
    {
        ...
        {
            var entidad = db.Entidad.Include(e => e.sectorEntidad);
        ...
        public ActionResult Create([Bind(Include = "Id,Razon_Social,Nit,Direccion,Telefono,Correo,Pagina,IdSector,Servicios")] Entidad entidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Razon_Social,Nit,Direccion,Telefono,Correo,Pagina,IdSector,Servicios")] Entidad entidad)
        {
            if (ModelState.IsValid)
            {
